...
<style>
    ...
    @media only screen and (max-width: 600px) {
        .footer-column {
            flex: 1 1 100px;
            /* Shrink down to 100px for small screens */
            max-width: 100%;
...
<footer style="padding: 20px 0; font-family: Arial, sans-serif; font-size:20px ">
    ...
    <div style="background-color: #f5f5f5; display: flex; justify-content: space-around; flex-wrap: wrap; padding-left:30px">
        ...
        <div class="footer-column">
            ...
            <p>Any questions? Let us know at our store at 8th floor, 379 Hudson St, New York, NY 10018 <br> or call us at (+1) 96 716 6879
            </p>
            <div>
    ...
    <div style="text-align: center; background-color: #f5f5f5;">
        ...
        <p>&copy; 2024 All rights reserved by Group 5 | Made with <i class="fas fa-heart"></i> by Group 5</p>
    </div>
</footer>
