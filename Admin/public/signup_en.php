      ...
      <div class="flex flex-col overflow-y-auto md:flex-row">
        <div class="h-32 md:h-auto md:w-1/2">
          ...
          <img aria-hidden="true" class="hidden object-cover w-full h-full dark:block"
            src="../images/create-account-office-dark.jpeg" alt="Office" />
        </div>
        <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
          <form action="Registration.php" method="POST">
            <div class="w-full">
              ...
              <label class="block text-sm">
                <span class="text-gray-700 dark:text-gray-400">Admin name</span>
                <input
              ...
              <label class="block mt-4 text-sm">
                ...
                <input
                  class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                  placeholder="john@example.com" type="email" name="email" required />
              </label>
              ...
              <label class="block mt-4 text-sm">
                ...
                <input
                  class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                  placeholder="***************" type="password" name="confirm-password" required />
              </label>
          ...
          <p class="mt-4">
            <a class="text-sm font-medium text-purple-600 dark:text-purple-400 hover:underline" href="./login_admin_en.php">
