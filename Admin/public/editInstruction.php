            ...
            <main class="h-full pb-16 overflow-y-auto">
                <div class="container grid px-6 mx-auto">
                    <div class="flex items-center my-6">
                        ...
                        <h2 style="padding: 20px"
                            class="stext-121 text-2xl font-semibold text-gray-700 dark:text-gray-200">
                            <a href="editInstruction.php?p_id=<?php echo $p_id ?>"><u>Edit Instruction</u></a>
                        </h2>
                    </div>

                    <div class="form-container container mt-5">
                        <form action="updateInstruction.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <?php if (!empty($p_tutorial)): ?>
                                    <p>Current File: <strong><?php echo $p_tutorial; ?></strong></p>
                                <?php endif; ?>
                            </div>
